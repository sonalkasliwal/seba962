...
public class GnmiClientImpl extends AbstractGrpcClient implements GnmiClient {
    ...
    public GnmiClientImpl(GnmiClientKey clientKey, ManagedChannel managedChannel, GnmiControllerImpl controller) {
            ...
            synchronized (this) {
                ...
                try {
                    ...
                    if (ex instanceof StatusRuntimeException) {
                        ...
                        log.warn(format(
                                "Exception while sending subscribe request to %s",
                                deviceId), ex);
                    }
                    complete();
                    return false;
